<nav class="navbar p-l-5 p-r-5">
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand"
                   href="{{route('dashboard',['role'=>strtolower(user()->roles->first()->name)])}}"><img
                        src="{{asset('templates/oreo/assets/images/logo.svg')}}" width="30"
                    ...
                    <ul class="menu list-unstyled">
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object w60" src="{{asset('templates/oreo/assets/images/image-gallery/1.jpg')}}" alt="">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object w60" src="{{asset('templates/oreo/assets/images/image-gallery/2.jpg')}}" alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object w60" src="{{asset('templates/oreo/assets/images/image-gallery/3.jpg')}}" alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object w60" src="{{asset('templates/oreo/assets/images/image-gallery/4.jpg')}}" alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object w60" src="{{asset('templates/oreo/assets/images/image-gallery/5.jpg')}}" alt="">
                                    <div class="media-body">
        ...
        <li class="float-right">
            <a class="mega-menu" title="Logout" data-close="true" href="{{ route('logout') }}"
