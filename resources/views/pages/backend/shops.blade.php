                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            @if(!\App\Shop::hasShops() || user()->shops()->count()==0)
                            <div class="card-header" style="margin-top: 10%;">
                                <p class="text-center">No Shops Yet</p>
                            </div>
                            @endif
                            @if(Auth::user()->hasRole('Landlord'))
                            <div>
                                <vuetable url="{{route('shops.all')}}" update_url="{{route('shops.update')}}"
                                    delete_url="{{route('shops.delete')}}" view_url="{{ request()->root().'/shop/' }}"
                                    titles="Name,Lacation,Status" data="name,location,status" action="View"
                            ...
                            <div>
                                <vuetable url="{{route('shops.all')}}" view_url="{{ request()->root().'/shop/' }}"
                                    titles="Name,Lacation,Status" data="name,location,status"></vuetable>
                            </div>
                            @endif
